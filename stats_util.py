# This stats utility file is an ongoing development in an innis shared repository
# the url to this repository is https://github.com/sgtcurran/def_snippets_innis_library/blob/main/statistics/stats_util.py
# The two contirbutors for this code are Ben Smith and Alejandro Garcia. 
# If it ain't broke, don't fix it. They wrote excellent stats functions, and I shall use them in this project. 
